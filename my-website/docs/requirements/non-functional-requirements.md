...
sidebar_position: 3
description: NFR по безопасности, производительности, надёжности, удобству и поддерживаемости.
---
