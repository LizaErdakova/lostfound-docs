...
они накапливаются и затем используются для агрегирования, отчётности и анализа. Для них важнее история, группировки и метрики, чем мгновенное транзакционное обновление. Объявления тоже используются для анализа, распределения по категориям, районам, типам, доли закрытых объявлений и тд.
